...
function vendorGuidance(key: string): {
  ...
  if (key === "sanmar") {
    return {
      ...
      stockWhen:
        "Use daily (or when prices/stock look wrong). Refreshes qty, CUSTOMER cost, and each Bulk part photo onto that colourway. Does not re-import the whole catalog. SanMar Bulk Data is limited to about 1 call per day.",
    };
  }
